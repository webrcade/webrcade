...
cd "$DIR" || { fail 'Unable to change to webrcade.'; }
# build
npm ci --no-optional --no-audit || { fail 'Unable to install webrcade dependencies.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install snes9x dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install genplusgx dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install javatari dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install js7800 dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install fceux dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install vba-m dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install mednafen dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install n64 dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install fbneo dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install beetle-psx dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install retro-genplusgx dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install retro-pce-fast dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install colem dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install beetle-pcfx dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install retro-a5200 dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install retro-neocd dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install retro-opera dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install quake dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install retro stella 2014 dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install retro stella dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install scummvm dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install dosbox dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install melonds dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
if test -d "$DIR/../webrcade-app-prboom"; then
    ...
    npm ci --no-optional --no-audit || { fail 'Unable to install prboom dependencies.'; }
    # npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install editor dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
...
npm ci --no-optional --no-audit || { fail 'Unable to install standalone dependencies.'; }
# npm link "@webrcade/app-common" || { fail 'Unable to link common.'; }
